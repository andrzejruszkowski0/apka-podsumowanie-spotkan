...
export const btnSecondary =
  "rounded-md border border-zinc-500 px-4 py-2 font-medium text-zinc-300 transition-transform hover:bg-zinc-800 active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100";

export const btnSecondarySm =
  "rounded-md border border-zinc-500 px-3 py-1 text-sm text-zinc-300 transition-transform hover:bg-zinc-800 active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100";
